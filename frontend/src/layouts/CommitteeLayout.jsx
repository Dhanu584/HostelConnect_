...
const sidebarLinks = [
  { label: 'Profile',   path: '/committee/profile',   icon: '👤' },
  { label: 'Buy & Sell',path: '/committee/buy-sell',   icon: '🛒' },
  { label: 'Settings',  path: '/committee/settings',   icon: '⚙️' },
];
        ...
        <div style={{
          ...
          <div style={{ padding: '24px 20px 20px', borderBottom: `1px solid ${theme.border}` }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <p style={{ margin: 0, color: theme.text, fontWeight: 600, fontSize: '15px' }}>{user?.name || 'Committee'}</p>
            ...
            <div style={{
              ...
              <span style={{ color: theme.accentText, fontSize: '11px', fontWeight: 600, letterSpacing: '0.5px', textTransform: 'uppercase' }}>Committee</span>
            </div>
          </div>
